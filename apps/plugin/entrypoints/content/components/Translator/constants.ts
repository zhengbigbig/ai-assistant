export const specialRules = [
  ...
  {
    hostname: ['www.msdmanuals.com'],
    noTranslateSelectors: ['.d-none'],
  },
  {
  ...
  },
  {
    ...
    blockElements: ['H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'OL', 'P', 'LI'],
  ...
  },
  {
    ...
    selectors: [
      'h1',
      'div.thread-message-content div.thread-message-content-body-text',
    ],
  ...
  },
  {
    ...
    selectors: [
      '[class^=CardFeaturedBlock_cardFeaturedBlock__title]',
      '[class^=CardBasic_cardBasic__title]',
      '[class^=CardExclusive_cardExclusive__title]',
      '[class^=card-horizontal-small_cardHorizontalSmall__title]',
    ],
    containerSelectors: 'article',
  },
  {
  ...
  },
  {
    ...
    selectors: ['h2.post_title'],
    containerSelectors: ['.comment_body > .md'],
  },
  {
...
// 行内忽略的HTML标签
export const HTML_TAGS_INLINE_IGNORE = ['BR', 'CODE', 'KBD', 'WBR'];
// 不翻译的HTML标签
export const HTML_TAGS_NO_TRANSLATE = [
  'TITLE',
  'SCRIPT',
  'STYLE',
  'TEXTAREA',
